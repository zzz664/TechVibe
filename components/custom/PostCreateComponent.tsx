...
function PostCreateComponent(props: Props) {
  ...
  return (
    <>
      {/*임시저장, 게시 버튼영역*/}
      <SaveButtonComponent post_data={{id: props.post_data ? props.post_data.id : props.id, title, content, main_category, sub_category, thumbnail}} onClickSaveDraft={onClickSaveDraft} />
      {/*게시글 작성하기 영역*/}
