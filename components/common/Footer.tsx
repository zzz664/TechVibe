      ...
      <div className="w-full max-w-[1328px] flex flex-col gap-6 p-6 pb-18">
        <div className="w-full flex items-start justify-between">
          ...
          <div className="flex items-center gap-2 pl-2">
            <p className="prevent-drag text-xs md:text-lg">FIRST</p>
            <Separator orientation="vertical" className="h-7!" />
            <p className="prevent-drag text-xs md:text-lg">NEXT.JS</p>
            <Separator orientation="vertical" className="h-7!" />
            <p className="prevent-drag text-xs md:text-lg">PROJECT</p>
          </div>
        </div>
        <Separator />
        <div className="w-full flex items-start justify-between">
          <div className="h-full flex flex-col gap-2 justify-between pr-2">
            <p className="text-[16px]/[1.5] md:text-xl font-semibold">
              CONTACT US
            </p>
            ...
            <p className="text-[11px]/[1.3] md:text-xs">
              © Seonwoo-Lee all rights reserved
            </p>
          </div>
          <div className="h-full flex flex-col gap-2 justify-between pl-2">
            <p className="text-[16px]/[1.5] md:text-xl font-semibold">
              제작자 정보
            </p>
            <div className="flex flex-col gap-1">
